...
public class Zombie6 extends Zombie {
   public Zombie6(EntityType<? extends Zombie> zombie, Level level) {
      super(zombie, level);
   }
   ...
   protected SoundEvent getAmbientSound() {
      return SoundsRegistry.ZOMBIE6_AMBIENT;
   }
   ...
   public static void onDeath(LivingDeathEvent death) {
      if(death.getEntityLiving() instanceof Zombie6) {
         LootHelper.dropLoot(ConfigurationHandler.LOOT.zombie6_loot.get(),
                 ConfigurationHandler.LOOT.zombie6_drop_chance.get(),

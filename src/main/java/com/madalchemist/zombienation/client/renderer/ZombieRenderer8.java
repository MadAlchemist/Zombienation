...
@OnlyIn(Dist.CLIENT)
public class ZombieRenderer8 extends AbstractZombieRenderer<Zombie8, ZombieModel<Zombie8>> {
    public ZombieRenderer8(EntityRendererProvider.Context p_174456_) {
        this(p_174456_, ModelLayers.ZOMBIE, ModelLayers.ZOMBIE_INNER_ARMOR, ModelLayers.ZOMBIE_OUTER_ARMOR);
    }

    public ZombieRenderer8(EntityRendererProvider.Context p_174458_, ModelLayerLocation p_174459_, ModelLayerLocation p_174460_, ModelLayerLocation p_174461_) {
    ...
    public ResourceLocation getTextureLocation(@Nonnull Zombie8 zombie) {
        return new ResourceLocation(Zombienation.MODID, "textures/entity/zombie/zombie_girl_3.png");
    }
}
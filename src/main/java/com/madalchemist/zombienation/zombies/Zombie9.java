...
public class Zombie9 extends ZombieEntity {

    public Zombie9(EntityType<? extends Zombie9> zombie, World world) {
        super(zombie, world);
    }
    ...
    public static void onDeath(LivingDeathEvent death) {
        if(death.getEntityLiving() instanceof Zombie9) {
            LootHelper.dropLoot(ConfigHandler.LOOT.zombie9_loot.get(),
                    ConfigHandler.LOOT.zombie9_drop_chance.get(),

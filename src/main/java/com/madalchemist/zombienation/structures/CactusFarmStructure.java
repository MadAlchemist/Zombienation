package com.madalchemist.zombienation.structures;
...
public class CactusFarmStructure extends Structure<NoFeatureConfig> {
    public CactusFarmStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return CactusFarmStructure.Start::new;
    }
    ...
    private static final List<MobSpawnInfo.Spawners> STRUCTURE_MONSTERS = ImmutableList.of(
            //new MobSpawnInfo.Spawners(ZombiesRegistry.ZOMBIE_4.get(), 100, 4, 9),
            //new MobSpawnInfo.Spawners(ZombiesRegistry.ZOMBIE_5.get(), 100, 4, 9)
    );
    @Override
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(Zombienation.MODID, "cactus_farm/start_pool")),
            ...
            Zombienation.LOGGER.log(Level.DEBUG, "Cactus farm at " +

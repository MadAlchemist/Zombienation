...
@OnlyIn(Dist.CLIENT)
public class ZombieRenderer1 extends AbstractZombieRenderer<Zombie1, ZombieModel<Zombie1>> {
    public ZombieRenderer1(EntityRendererProvider.Context p_174456_) {
        this(p_174456_, ModelLayers.ZOMBIE, ModelLayers.ZOMBIE_INNER_ARMOR, ModelLayers.ZOMBIE_OUTER_ARMOR);
    }

    public ZombieRenderer1(EntityRendererProvider.Context p_174458_, ModelLayerLocation p_174459_, ModelLayerLocation p_174460_, ModelLayerLocation p_174461_) {
    ...
    public ResourceLocation getTextureLocation(@Nonnull Zombie1 zombie) {
        return new ResourceLocation(Zombienation.MODID, "textures/entity/zombie/zombie_steve.png");
    }
}
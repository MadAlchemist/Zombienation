...
public class Zombie7 extends Zombie {
   public Zombie7(EntityType<? extends Zombie> zombie, Level level) {
      super(zombie, level);
   }
   ...
   public static void onDeath(LivingDeathEvent death) {
      if(death.getEntityLiving() instanceof Zombie7) {
         LootHelper.dropLoot(ConfigurationHandler.LOOT.zombie7_loot.get(),
                 ConfigurationHandler.LOOT.zombie7_drop_chance.get(),

...
public class Zombie3 extends ZombieEntity {

    public Zombie3(EntityType<? extends Zombie3> zombie, World world) {
        super(zombie, world);
    }
    ...
    protected SoundEvent getAmbientSound() {
        return SoundsRegistry.ZOMBIE3_AMBIENT;
    }
    ...
    public static void onDeath(LivingDeathEvent death) {
        if(death.getEntityLiving() instanceof Zombie3) {
            LootHelper.dropLoot(ConfigHandler.LOOT.zombie3_loot.get(),
                    ConfigHandler.LOOT.zombie3_drop_chance.get(),

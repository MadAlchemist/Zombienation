...
public class ModdedNearestAttackableTargetGoal<T extends LivingEntity> extends TargetGoal {
   protected final Class<T> targetType;
   protected final int randomInterval;
   protected LivingEntity target;
   protected EntityPredicate targetConditions;

   public ModdedNearestAttackableTargetGoal(MobEntity p_i50313_1_, Class<T> p_i50313_2_, boolean p_i50313_3_) {
         this(p_i50313_1_, p_i50313_2_, p_i50313_3_, false);
   }

   public ModdedNearestAttackableTargetGoal(MobEntity p_i50314_1_, Class<T> p_i50314_2_, boolean p_i50314_3_, boolean p_i50314_4_) {
      this(p_i50314_1_, p_i50314_2_, 10, p_i50314_3_, p_i50314_4_, (Predicate<LivingEntity>)null);
   }

   public ModdedNearestAttackableTargetGoal(MobEntity p_i50315_1_, Class<T> p_i50315_2_, int p_i50315_3_, boolean p_i50315_4_, boolean p_i50315_5_, @Nullable Predicate<LivingEntity> p_i50315_6_) {
   ...
   public void start() {
      if(this.mob instanceof ZolphinEntity){
         if(this.target instanceof ZolphinEntity || this.target instanceof ZombieEntity) {
            this.target = null;
         }
      }
      if(this.mob instanceof DrownedEntity){
         if(this.target instanceof ZolphinEntity || this.target instanceof ZombieEntity) {
            this.target = null;
         }
      }

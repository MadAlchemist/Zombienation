...
public class Structures {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, Zombienation.MODID);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                CACTUS_FARM.get(), /* The instance of the structure */

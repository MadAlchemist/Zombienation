...
@OnlyIn(Dist.CLIENT)
public class ZombieRenderer5 extends AbstractZombieRenderer<Zombie5, ZombieModel<Zombie5>> {
    public ZombieRenderer5(EntityRendererProvider.Context p_174456_) {
        this(p_174456_, ModelLayers.ZOMBIE, ModelLayers.ZOMBIE_INNER_ARMOR, ModelLayers.ZOMBIE_OUTER_ARMOR);
    }

    public ZombieRenderer5(EntityRendererProvider.Context p_174458_, ModelLayerLocation p_174459_, ModelLayerLocation p_174460_, ModelLayerLocation p_174461_) {
    ...
    public ResourceLocation getTextureLocation(@Nonnull Zombie5 zombie) {
        return new ResourceLocation(Zombienation.MODID, "textures/entity/zombie/hazmat_zombie.png");
    }
}
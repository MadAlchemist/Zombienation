...
public class Zombie3 extends Zombie {
   public Zombie3(EntityType<? extends Zombie> zombie, Level level) {
      super(zombie, level);
   }
   ...
   public static void onDeath(LivingDeathEvent death) {
      if(death.getEntityLiving() instanceof Zombie3) {
         LootHelper.dropLoot(ConfigurationHandler.LOOT.zombie3_loot.get(),
                 ConfigurationHandler.LOOT.zombie3_drop_chance.get(),

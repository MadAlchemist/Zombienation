...
public class Zombie4 extends ZombieEntity {

    public Zombie4(EntityType<? extends Zombie4> zombie, World world) {
        super(zombie, world);
    }
    ...
    protected SoundEvent getAmbientSound() {
        return SoundsRegistry.ZOMBIE4_AMBIENT;
    }
    ...
    public static void onDeath(LivingDeathEvent death) {
        if(death.getEntityLiving() instanceof Zombie4) {
            LootHelper.dropLoot(ConfigHandler.LOOT.zombie4_loot.get(),
                    ConfigHandler.LOOT.zombie4_drop_chance.get(),

...
public class Zombie4 extends Zombie {
   public Zombie4(EntityType<? extends Zombie> zombie, Level level) {
      super(zombie, level);
   }
   ...
   public static void onDeath(LivingDeathEvent death) {
      if(death.getEntityLiving() instanceof Zombie4) {
         LootHelper.dropLoot(ConfigurationHandler.LOOT.zombie4_loot.get(),
                 ConfigurationHandler.LOOT.zombie4_drop_chance.get(),

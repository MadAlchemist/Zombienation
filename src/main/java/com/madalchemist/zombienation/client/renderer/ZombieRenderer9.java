...
@OnlyIn(Dist.CLIENT)
public class ZombieRenderer9 extends AbstractZombieRenderer<Zombie9, ZombieModel<Zombie9>> {
    public ZombieRenderer9(EntityRendererProvider.Context p_174456_) {
        this(p_174456_, ModelLayers.ZOMBIE, ModelLayers.ZOMBIE_INNER_ARMOR, ModelLayers.ZOMBIE_OUTER_ARMOR);
    }

    public ZombieRenderer9(EntityRendererProvider.Context p_174458_, ModelLayerLocation p_174459_, ModelLayerLocation p_174460_, ModelLayerLocation p_174461_) {
    ...
    public ResourceLocation getTextureLocation(@Nonnull Zombie9 zombie) {
        return new ResourceLocation(Zombienation.MODID, "textures/entity/zombie/lumberjack.png");
    }
}